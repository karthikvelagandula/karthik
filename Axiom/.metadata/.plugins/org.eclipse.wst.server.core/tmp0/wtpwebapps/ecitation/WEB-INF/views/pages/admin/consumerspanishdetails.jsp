							...
							<table width="900">
											...
											<div class="col-md-6">
												<div>
													<input id="infoCorrect" type="checkbox" name="ticketInfo"
														...
														class="registerAns"><b>Si, ésta es la
															información correcta.</b></font>
												</div>
											</div>
								...
								<tr>
									<td><font class="bodySmall"><b>Consultando
												documento: Infracción ${citationId}</b><br> Usted tiene un
											total de <b>1</b> infracción(es) en su cuenta.</font></td>
								</tr>
								<tr>
									<td width="100%" class="bodySmall" valign="top"><br>
									<b> </b> La cantidad de la infracción introducida es: <b>${consumer.penaltyAmt}</b><br>
										La cantidad total de su(s) infracción(es) es: <b>$</b><b>${consumer.totalDue}</b><br>
										<br>
										...
										<table width="72%" border="0" cellpadding="2" cellspacing="2">
											<tr>
												<td><input id="violationPay" type="radio"
													...
													class="bodySmall">Desearía pagar únicamente esta
														infracción.</font> <span>&nbsp;<form:errors
								...
								<tr>
									<td>
										...
										<table style="margin-top: 25px;"
											...
											<thead>
												<tr>
													<th width="14%"><u>Número deInfracción:</u></th>
													<th width="14%"><u>Fecha de<br />emisión
													</u></th>
													<th width="14%"><u>Violación</u></th>
                    ...
                    &nbsp;<a
												...
												<c:if
													...
													<a data-toggle="modal" href="#myModal"><button
															type="button" class="btn green btn-sm"
															style="width: 200px;">Tránsito Colegio</button></a>
												</c:if>
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<h4 class="modal-title" id="myModalLabel">
															<i class="text-muted fa fa-university"></i>Tránsito
															Colegio
														</h4>
													</div>
													<div class="modal-body">
														...
														<table class="pull-left col-md-10"
															...
															<tbody>
																...
																<tr>
																	<td class="h6"><strong>Último Nombre</strong></td>
																...
																<tr>
																	...
																	<td><button type="button"
																			...
																			class="btn btn-primary btn-md" style="width: 150px;">Tránsito
																			Colegio</button></td>
																</tr>
															</tbody>
														</table>
     ...
     $(document).ready(function() {
    	 ...
    	 document.getElementById('consumerdetails1Error').innerHTML = '';
    	    $("#checkpay").click(function(){
    	    	...
    	    	if(!$('#violationPay').is(':checked')){
    	    		document.getElementById('consumerdetails1Error').innerHTML = 'Seleccionar Radio botón';
...
function checkLastName() {
    ...
    if(lname == userSelName) {
        ...
        document.getElementById('lnameMismatch').innerHTML = 'por favor entrar en válido Último Nombre';
    }    
}
</script>
