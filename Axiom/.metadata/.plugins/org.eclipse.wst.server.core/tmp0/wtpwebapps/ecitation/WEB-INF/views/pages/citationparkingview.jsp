							...
							<div class="portlet-body " style="padding: 6px;">
								<table style="font-size: 13px;">
									...
									<tr>
										<th><b>VIN:</b></th>
										<td><font style="font-weight: 400;"><c:out
													value="${citationForm.plateEntity.vinNumber}" /></font></td>
									</tr>
									<tr>
										<th><b>Related Violations:</b></th>
										<td><font style="font-weight: 400;"><c:out
													value="" /></font></td>
									</tr>
								</table>
									...
									<div class="col-md-6 col-sm-6"
										...
										<table style="font-size: 13px;">
											...
											<tr>
												<th><b>Make:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="${citationForm.plateEntity.vehicleMake}" /></font></td>
											</tr>
											<tr>
												<th><b>Model:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="${citationForm.plateEntity.vehicleModel}" /></font></td>
											</tr>
											<tr>
												<th><b>Color:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="${citationForm.plateEntity.vehicleColor}" /></font></td>
											</tr>
											<tr>
												<th><b>Body Style:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="" /></font></td>
											</tr>
											<tr>
												<th><b>Type:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="${citationForm.plateEntity.bodyType}" /></font></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><font style="font-weight: 400;"><c:out
															value="${citationForm.plateEntity.licenceNumber}" /></font></td>
											</tr>
										</table>

									</div>
									<!--Badge, Agency, Division, Route, Make, Model, Color, Body Style, Type, Vehicle Year, Plate, Tag Expiration, RPP, Meter, Speed Zone, Speed Actual, Overweight, Radar IND, Hazard IND, Accident, Plate Year, Plate Color -->
									<div class="col-md-6 col-sm-6"
										style="padding-left: 10px; padding-right: 0px;">
										<table style="font-size: 13px;">
											<tr>
											...
											<tr>
												<th><b>Speed Zone:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="" /></font></td>
											</tr>
											<tr>
												<th><b>Speed Actual:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="" /></font></td>
											</tr>
											<tr>
												<th><b>Overweight:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="" /></font></td>
											</tr>
											<tr>
											...
											<tr>
												<th><b>Plate Year:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="${citationForm.plateEntity.licenseYear}" /></font></td>
											</tr>
											<tr>
												<th><b>Plate Color:</b></th>
												<td><font style="font-weight: 400;"><c:out
															value="" /></font></td>
											</tr>
										</table>
