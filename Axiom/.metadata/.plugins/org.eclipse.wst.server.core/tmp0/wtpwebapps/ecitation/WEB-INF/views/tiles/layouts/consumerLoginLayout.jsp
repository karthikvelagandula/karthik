...
<link href="<c:url value='/static/assets/pages/css/login-5.min.css' />"
	rel="stylesheet" type="text/css" />
<link href="<c:url value='/static/assets/pages/css/login-4.min.css' />"
	rel="stylesheet" type="text/css" />
...
<link rel="shortcut icon"
	href="static/assets/layouts/layout/img/header-metro-logo.png" />
</head>
<!-- END HEAD -->

<body style="bgcolor: white" class=" login">
	...
	<!-- BEGIN PAGE LEVEL PLUGINS -->
	<script
		src="<c:url value='/static/assets/global/plugins/jquery-validation/js/jquery.validate.min.js ' />"
		type="text/javascript"></script>
	<script
		src="<c:url value='/static/assets/global/plugins/jquery-validation/js/additional-methods.min.js' />"
		type="text/javascript"></script>
	<script
	...
	<script
		src="<c:url value='/static/assets/pages/scripts/login-5.min.js' />"
		type="text/javascript"></script>
	<script
		src="<c:url value='/static/assets/pages/scripts/login-4.min.js'/>"
		type="text/javascript"></script>
