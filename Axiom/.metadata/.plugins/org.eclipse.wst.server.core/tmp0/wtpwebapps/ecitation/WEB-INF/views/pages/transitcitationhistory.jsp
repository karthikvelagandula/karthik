			...
			<div class="row">
				...
				<form
					...
					<div class="form-group" style="margin-left: -20px;">
						...
						<div class="col-md-3">
							<select class="form-control input-sm" id="historyItem" name="historyItem">
						...
						<div class="col-md-2" style="margin-left: 10px;">
							<button type="button" class="btn green btn-sm icon-printer"
								id="printBtn"
																			...
																			<c:when test="${address.updatedAt == null}">
																				<c:if test="${not empty address.formattedAddress}">
																					<tr>
																						...
																						<td><c:out
																								value="${address.formattedCreatedAt}" /></td>
																					</tr>
																				</c:if>
																			</c:when>
																			<c:otherwise>
																			...
																			<c:choose>
																				<c:when test="${penalty.updatedAt == null}">
																					<td style="text-transform: uppercase;">&#36;<c:out
																							...
																							<c:when
																								test="${not empty penalty.penaltyCode.penalty4}">
																							&#36;<c:out
																									value="${penalty.penaltyCode.penalty4}" />/
																							<c:out
																									value="${penalty.penaltyCode.formattedpenalty4}" />&#44;
																							</c:when>
																							<c:otherwise>
																							&#36;<c:out value="0.00" />/
																							<c:out
																							...
																							<c:when
																								test="${not empty penalty.penaltyCode.penalty5}">
																							&#36;<c:out
																									value="${penalty.penaltyCode.penalty5}" />/
																							<c:out
																									value="${penalty.penaltyCode.formattedpenalty5}" />&#44;
																							</c:when>
																							<c:otherwise>
																							&#36;<c:out value="0.00" />/
																							<c:out
																						...
																						</c:choose> $<c:out value="${penalty.citation.totalDue}" /></td>
																					<td style="text-transform: uppercase;"><c:out
																					...
																					<c:when test="${payment.updatedAt == null}">
																						<td style="text-transform: uppercase;">$<c:out
																							...
																							<c:out value="${payment.account}" />&#44; <c:out
																								...
																								<c:out value="NO" />&#44;
																		</c:if> &#36;<c:out value="${payment.overPaid}" />&#44;
																							&#36;<c:out value="${payment.totalDue}" />&#44;&nbsp;<c:out
																				...
																				<c:choose>
																					<c:when test="${suspend.updatedAt == null}">
																						<td style="text-transform: uppercase;"><c:out
																							...
																							</c:choose> &#36;<c:out value="${suspend.totalDue}" /></td>
																						<td style="text-transform: uppercase;"><c:out
													...
													<div class="portlet-body">
														<div class="table-responsive scroller">
															<table id="adrsTbl"
																...
																<thead>
																	<tr style="background-color: #f5f3eb;">
																		<th style="color: #32c5d2" width="15%"><b>Address</b></th>
																		<th style="color: #32c5d2" width="15%"><b>City</b></th>
																		<th style="color: #32c5d2" width="15%"><b>State</b></th>
																		<th style="color: #32c5d2" width="15%"><b>Zip
																				Code</b></th>
																		<th style="color: #32c5d2" width="20%"><b>Updated
																				By</b></th>
																		<th style="color: #32c5d2" width="20%"><b>Updated
																			...
																			<tr>
																				<c:choose>
																					<c:when test="${hearing.updatedAt == null}">
																						...
																						<td style="text-transform: uppercase;"><c:out
																								value="${hearing.disposition}" />/<br> <c:out
																								value="${hearing.userId}" /></td>
																						<td style="text-transform: uppercase;"><c:out
																								value="${hearing.suspend}" />/<c:out
																								value="${hearing.suspendUntil}" /></td>
																						<td style="text-transform: uppercase;"><c:out
																								value="${hearing.caseNumber}" />/<br> <c:out
																								value="${hearing.plea}" /></td>
																						<td style="text-transform: uppercase;">$<c:out
																					...
																					<c:otherwise>
																						...
																						<td style="text-transform: uppercase;"><c:out
																								...
																								value="${hearing.userId}" /></td>
																						<td style="text-transform: uppercase;"><c:out
																								value="${hearing.suspend}" />/<br> <c:out
																								value="${hearing.suspendUntil}" /></td>
																						<td style="text-transform: uppercase;"><c:out
																								value="${hearing.caseNumber}" />/<br> <c:out
																								value="${hearing.plea}" /></td>
